...
function yith_wcwtl_install_free_admin_notice() {
	?>
	<div class="error">
		<p><?php esc_html_e( 'You can\'t activate the free version of YITH WooCommerce Waiting List while you are using the premium one.', 'yith-woocommerce-waiting-list' ); ?></p>
	</div>
	<?php
}
...
if ( ! defined( 'YITH_WCWTL_VERSION' ) ) {
	define( 'YITH_WCWTL_VERSION', '1.18.0' );
}
